...
export function AnimatedNumberRandomDemo() {
  ...
  return (
    <div className="flex flex-col mt-20 items-center justify-center ">
      <Badge
        variant="outline"
        className="rounded-[14px] border  text-base  md:left-6"
      >
        <Shell className="fill-[#EEBDE0] stroke-1 " />
        &nbsp;Shuffle component
      </Badge>
      ...
      <button
        ...
        className="duration-[.10s]  ease-[cubic-bezier(.4,0,.2,1)] active:duration-[25ms] mx-auto mt-2 flex h-11 w-fit items-center  rounded-full bg-zinc-900 px-5 text-sm font-medium text-zinc-50 transition hover:brightness-125 active:scale-[98%] active:brightness-[98%]"
      >
        <RefreshCcw className="size-5" />
        Shuffle
      </button>
      <div className='mt-10 mb-5 text-3xl text-center '>
        <h1>Components are fully designed product </h1>
      <h1>and even have <span className='font-bold'>real daily active uses.</span></h1>
      </div>
      <svg
        width="100"
        height="50"
        ...
        className="fill-black mt-3 dark:fill-white"
      >
      ...
      <div className='border w-[900px] h-[200px] mt-10 p-8 mb-20 rounded-3xl  '>
         <BadgeButton>
            Additional goods
         </BadgeButton>
         <div className='flex justify-between  items-center  '>
            <div className='w-[250px] h-[120px] border rounded-3xl hover:bg-blue-100 text-start p-2 '>
                <h1 className='font-bold'>Free AI Marketing</h1>
                <p  className='text-sm'>An AI Cofounder that knows your brand. Start creating marketing copy that converts.</p>
            </div>
             <div className='w-[250px] h-[120px] border rounded-3xl hover:bg-blue-100 text-start p-2 '>
                <h1 className='font-bold'>Free SEO Improvement Tool</h1>
                <p  className='text-sm'>Quickly evaluate your website's SEO performance for free. AI imrovements + Open graph preview.</p>
            </div>
           <div className='w-[250px] h-[120px] border hover:bg-blue-100 rounded-3xl text-start p-2 '>
                <h1 className='font-bold'>Full Stack Shadcn Templates</h1>
                <p  className='text-sm'>Comprehensive Next.js + Supabase templates build with Tailwind CSS, Skiper Components, and shadcn.</p>
            </div>
         </div>
      </div>
    </div>
...
const Count = () => {
  return <AnimatedNumberRandomDemo />
}
